...
module.exports = {
  ...
  'Helpers': {
    ...
    '#inspect': {
      '()': function() {
        assert.property ( args, '_inspect' );
        assert.typeOf ( args._inspect, 'function' );
      }
    },

    '#debug': {
      '()': function() {
        assert.property ( args, '_debug' );
        assert.typeOf ( args._debug, 'function' );
      }
    }
  },
  ...
  'One argument': {
    'function(undefined) arguments should be an Array: [undefined]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ undefined ]" );
      }
    ...
    'function(null) arguments should be an Array: [null]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ null ]" );
      }
    ...
    'function(null) arguments should be an Array: [true]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ true ]" );
      }
    ...
    'function(null) arguments should be an Array: [false]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ false ]" );
      }
    ...
    'function("fun") arguments should be an Array: ["fun"]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ 'fun' ]" );
      }
    ...
    'function(1337) arguments should be an Array: [1337]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ 1337 ]" );
      }
    ...
    'function({fun: "args"}) arguments should be an Array: [{fun: "args"}]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ { fun: 'args' } ]" );
      }
    ...
    'function(function a() {}) arguments should be an Array: [function a() {}]': function() {
      ...
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ [Function] ]" );
      }
  ...
  'Multiple arguments - of same kind': {
    'function(undefined, undefined) arguments should be an Array: [undefined, undefined]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ undefined, undefined ]" );
      }
    ...
    'function(null, null) arguments should be an Array: [null, null]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ null, null ]" );
      }
    ...
    'function(13, 37) arguments should be an Array: [13, 37]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ 13, 37 ]" );
      }
    ...
    'function({fun: "args"}, {args: "fun"}) arguments should be an Array: [{fun: "args"}, {args: "fun"}]': function() {
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ { fun: 'args' }, { args: 'fun' } ]" );
      }
    ...
    'function(function a() {}, function b() {}) arguments should be an Array: [function a() {}, function b() {}]': function() {
      ...
      var fun = function() {
        ...
        assert.deepEqual ( args._inspect(), "[ [Function], [Function] ]" );
      }
